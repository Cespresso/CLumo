...
class PatternEditorOperationTest {
    ...
    @Test
    fun navigationWaitsUntilPersistenceCompletes() =
        runBlocking {
    ...
    @Test
    fun persistenceFailureDoesNotNavigate() =
        runBlocking {
    ...
    @Test
    fun cancellationIsRethrownWithoutReportingAPersistenceFailure() =
        runBlocking {
    ...
    @Test
    fun navigationFailureIsNotReportedAsAPersistenceFailure() =
        runBlocking {
