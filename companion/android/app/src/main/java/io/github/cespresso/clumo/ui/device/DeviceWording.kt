...
@Composable
internal fun DeviceStateLabel.text(reconnectAttempt: Int): String = when (this) {
...
@Composable
internal fun DeviceFailureMessage.text(): String = when (this) {
...
@Composable
internal fun DeviceFailureAction.label(): String = when (this) {
